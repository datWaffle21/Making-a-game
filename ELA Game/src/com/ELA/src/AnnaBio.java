...
public class AnnaBio extends Level {


	private LevelManager levelManager;
	
	private Image anna, scaledAnna;
	...
	public AnnaBio(int numImages, LevelManager levelManager) {
		super(numImages);
		...
		scaledAnna = scaleImage(anna, BufferedImage.TYPE_INT_RGB, 525, 525);
	...
	public void render(Graphics g) {
		if(levelManager.getLevelIndex() == 4) {
			...
			g.drawImage(scaledAnna, 1000, 100, null);
			...
			g.drawString("When Rachel thinks of Anna, the woman her husband", 140, 230);
			g.drawString("cheated on her with, she thinks of her as a", 140, 270);
			g.drawString("horrible man-stealing witch. Anna doesn't care", 140, 310);
			g.drawString("that Tom is a liar—she only cares that Tom is", 140, 350);
			g.drawString("lying to her. But anna is a good mother, she ", 140, 390);
			g.drawString("cares for her baby, Evie.", 140, 430);
